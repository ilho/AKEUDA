...
if (!checkrights("PO") || !defined("iAUTH") || $_GET['aid'] != iAUTH) { redirect("../index.php"); }
...
if (isset($_POST['save'])) {
	...
	$result = dbquery("SELECT * FROM ".DB_POLLS." WHERE poll_id='".$_POST['poll_id']."'");
	if (dbrows($result) != 0) $result = dbquery("DELETE FROM ".DB_POLLS." WHERE poll_id='".$_POST['poll_id']."'");
